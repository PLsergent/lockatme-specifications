...
recouvert d'un filtre transparent avec un cadenas (voir figure~\ref{fig:lockScreen}). A noterque durant cette période de verrouillage, l'écran de l'ordinateur pourra très bien
