...
juju_face_encoding = face_recognition.face_encodings(jujuimage)[0]
pl_face_encoding = face_recognition.face_encodings(plimage)[0]
...
while True:
     ...
     for (top, right, bottom, left), face_encoding in zip(face_locations,
       face_encodings):
          ...
          match = face_recognition.compare_faces([jujuface_encoding],
            face_encoding)
          match1 = face_recognition.compare_faces([plface_encoding],
            face_encoding)
          name = "Unknown"
          if match[0]:
               name = "Juliette"
